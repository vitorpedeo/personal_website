...
Finally our page transitions are implemented! To see it in action, paste the following code to <InlineCode>index.tsx</InlineCode> file:
...
- If you pay attention to the above GIF, you'll see that the horizontal scrollbar is appearing and disappearing between the animations. Try to fix it! (Tip: <InlineCode>overflow-x</InlineCode>).
