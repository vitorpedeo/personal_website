...
- Se você prestar atenção no GIF acima, você irá perceber que a scrollbar horizontal está aparecendo e desaparecendo entre as animações. Tente arrumar isso! (Dica: <InlineCode>overflow-x</InlineCode>).
